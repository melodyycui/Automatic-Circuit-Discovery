...
def parse_args():
    ...
    parser.add_argument("--dataset-path", "-d", default="/scratch/network/mc3803/Edge-Pruning/data/datasets/ioi-t1")
    parser.add_argument("--max-train-examples", "-n", default=50, type=int)
    ...
    if args.out_json_path is None:
        args.out_json_path = f"/scratch/network/mc3803/Edge-Pruning/data/acdc_results/ioi_t1-t{args.threshold}-graph.json"
    if args.out_pickle_path_final is None:
        args.out_pickle_path_final = f"/scratch/network/mc3803/Edge-Pruning/data/acdc_results/ioi_t1-t{args.threshold}-graph.pkl"
    return args
